...
function PostpaidTitle() {
    return (
        <div className="container">
            <div className="d-flex justify-content-between alihn-items-center py-2">
                <h3 className="mb-0" style={{ fontSize: '14px' }}>All mobile operators</h3>
            </div>
            ...
            <div className="d-flex py-2 align-items-center">
                ...
                <div className="px-3">
                    <h2 className="mb-0" style={{ fontSize: '12px' }}>Airtel Postpaid Mobile</h2>
                </div>
            </div>
            ...
            <div className="d-flex py-2 align-items-center">
                ...
                <div className="px-3">
                    <h2 className="mb-0" style={{ fontSize: '12px' }}>BSNL Postpaid Mobile</h2>
                </div>
            </div>
            ...
            <div className="d-flex py-2 align-items-center">
                ...
                <div className="px-3">
                    <h2 className="mb-0" style={{ fontSize: '12px' }}>MTNL Delhi - Dolphin</h2>
                </div>
            </div>
            ...
            <div className="d-flex py-2 align-items-center">
                ...
                <div className="px-3">
                    <h2 className="mb-0" style={{ fontSize: '12px' }}>MTNL Dolphin - Mumbai Postpaid Mobile</h2>
                </div>
            </div>
            ...
            <div className="d-flex py-2 align-items-center">
                ...
                <div className="px-3">
                    <h2 className="mb-0" style={{ fontSize: '12px' }}>Vi Postpaid Mobile</h2>
                </div>
            </div>
            ...
            <div className="d-flex py-2 align-items-center">
                ...
                <div className="px-3">
                    <h2 className="mb-0" style={{ fontSize: '12px' }}>Wiwanet Solution</h2>
                </div>
            </div>
